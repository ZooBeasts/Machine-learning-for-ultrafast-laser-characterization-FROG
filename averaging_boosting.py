...
shg_real_path = 'E:/FROGS/new_logs/shg240.pt'
shg_imag_path = 'E:/FROGS/new_logs/shg_imag170.pt'
thg_real_path = 'E:/FROGS/new_logs/thg340.pt'
thg_imag_path = 'E:/FROGS/new_logs/thg_imag290.pt'
...
class averaging_boosting:
    ...
    def plot_averaged_output(self, plot=False, save=False):
        ...
        ax1.plot(wl, real.reshape(200, 1) - 1.0, '--r', label='pred')
        ...
        ax2.plot(wl, imag.reshape(200, 1) - 1.0, '--r', label='pred')
